...
def add_student():
    ...
    if request.method == "POST":
        ...
        _dept_row = db.execute("SELECT id FROM departments ORDER BY id LIMIT 1").fetchone(); dept_id = _dept_row["id"] if _dept_row else None
    ...
    db.close(); return render_template("student_form.html", student=None, title="Add Student", year_options=YEAR_OPTIONS)
